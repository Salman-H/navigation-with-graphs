...
public class GoogleMap extends JavascriptObject {
	 ...
	 *
	 * @param x
	 *            delta x value in pixels.
	 * @param y
	 *            delta y value in pixels.
	 */
	 ...
	 *
	 * @param type
	 *            Type of the event to register against.
	 * @param h
	 ...
	 *
	 * @param obj
	 *            The object that the event should be registered on.
	 * @param type
	 *            Type of the event to register against.
	 * @param h
	 *            Handler that will be called when the event occurs.
