...
public class JavascriptObject {
	 ...
	 *
	 * @param type
	 *            The type of underlying Javascript object to create
	 */
	...
	/**
	 * Builds a new JavascriptObject based on a string representation of the
	 * object. This is useful when constructing functions as objects
	 * 
	 * @param type
	 *            The type of object to build
	 * @param stringRepresentation
	 *            A string representation of the object, which can be executed
	 ...
	 *            The type of underlying Javascript object to create.
	 * @param args
	 *            Any arguments required to create the object.
	 */
	 ...
	 *            The type of underlying Javascript object to create.
	 * @param ary
	 *            The array to be passed in.
	 * @param isArray
	 *            boolean to indicate the an array is to be used as the
	 ...
	 * @param jsObject
	 *            Object returned from Javascript.
	 */
	...
	/**
	 * JSObject will return the String "undefined" at certain times, so we need
	 * to make sure we're not getting a value that looks valid, but isn't.
	 *
	 * @param val
	 *            The value from Javascript to be checked.
	 ...
	 *            The value from Javascript to be checked.
	 * @param def
	 *            The default return value, which can be null.
