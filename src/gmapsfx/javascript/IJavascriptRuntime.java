...
public interface IJavascriptRuntime {
	 ...
	 *
	 * @param command
	 *            The JavaScript command to execute
	 ...
	 *
	 * @param javascriptObjectType
	 *            The type of JavaScript object to create
	 * @param args
	 *            The args of the constructor
	...
	/**
	 * Gets an array parameter constructor as a String, which then can be passed
	 * to the execute() method. Note, this is where the parameter to the
	 * constructor is an array, rather than the varargs which are broken down
	 * into separate parameters.
	 *
	 * @param javascriptObjectType
	 *            type The type of JavaScript object array to create
	 * @param ary
	 *            The array elements
	 * @return A string which can be passed to the JavaScript environment to
	 *         create a new array.
	 ...
	 * 
	 * @param variable
	 *            The variable to invoke the function on.
	 * @param function
