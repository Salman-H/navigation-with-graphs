...
public class GoogleMapView extends AnchorPane {
	 ...
	 *     <meta charset="utf-8">
	 *     <title>My Map</title>
	 *     <style> html, body, #map-canvas { height: 100%; margin: 0px; padding:
	 * 0px } </style> <script src=
	 ...
	 * @param mapResourcePath
	 * @param debug
	 *            true if the FireBug pane should be displayed in the WebView.
	 */
	...
	private void mapResized() {
		if (initialized) {
			// map.triggerResized();
			// System.out.println("GoogleMapView.mapResized: triggering resize
			// event");
